...
use Domain\Payment\Requests\InstallmentPaymentRequest;  
...
class InstallmentPaymentController
{
    ...
    ): JsonResponse
    {
        ...
        $result = $paymentService->register($orderNumber, $amount, $currency, route('installments.payment.callback'), $installment->policy->user_id);
