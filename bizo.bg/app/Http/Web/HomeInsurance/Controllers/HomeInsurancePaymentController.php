...
use Domain\Axiom\HomeInsurance\Requests\AxiomHomeInsurancePaymentRequest;
use Domain\Payment\Services\PaymentService;
use Illuminate\Http\JsonResponse;
use Illuminate\Support\Str;

class HomeInsurancePaymentController
{
    public function __invoke(
        AxiomHomeInsurancePaymentRequest $request,
        AxiomHomeInsuranceOffer $offer,
    ...
    ): JsonResponse
    {
        ...
        $result = $paymentService->register($orderNumber, $amount, $currency, route('home-insurance.payment.callback'), $offer->user_id);
