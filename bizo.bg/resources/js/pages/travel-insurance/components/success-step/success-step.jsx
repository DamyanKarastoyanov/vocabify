...
const SuccessStep = () => {
    const { travel_insurance, auth } = usePage().props;
    const {
        policy: policyData,
        currency,
        debit_note_url,
                                ...
                                {user === null ? (
                                    ...
                                    <Button
                                        ...
                                        href={
                                            ...
                                            "?filter=insurance_type%3AЗастраховка%20при%20пътуване%20в%20чужбина"
                                        }
                                    >
                                        Виж своите полици
                                    </Button>
    ...
    const bubbleText = policyData
        ? policyData.status === 5
            ? "Плащането е успешно! Полицата ти вече се изготвя, щом е готова, веднага ще ти я изпратя на имейла."
            : "Готово! Полицата ти е активна и документите вече пътуват към имейла ти."
        : "Още една крачка и всичко е готово! Завърши плащането, за да активирам твоята полицa.";
