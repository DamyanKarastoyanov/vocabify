...
const SuccessStep = () => {
    const { mtpl_insurance, auth } = usePage().props;
    const {
        policy: policyData,
        currency,
        debit_note_url,
    ...
    const renderSuccessStep = () => {
        return (
            <Box className="mtpl-insurance__success-page-holder">
                <Surface>
                    <Box className="mtpl-insurance__success-holder">
                        <BlockStack gap="800">
                            ...
                            {policyData ? (
                                <Box>
                                    ...
                                    >
                                        {policyData.status == 5 ? (
                                            <>
                                                <Box className="mtpl-insurance__success-text-details-holder">
                                                    <Text
                                                        variant="body-l"
                                                        fontWeight="semibold"
                                                    >
                                                ...
                                                <Box className="mtpl-insurance__success-text-details-holder-secondary">
                                                    <BlockStack
                                                        gap="300"
                                                        inlineAlign="start"
                                                    >
                                ...
                                {user === null ? (
                                    ...
                                    <Button
                                        ...
                                        href={
                                            ...
                                            "?filter=insurance_type%3AГражданска%20отговорност"
                                        }
                                    >
                                        Виж своите полици
                                    </Button>
