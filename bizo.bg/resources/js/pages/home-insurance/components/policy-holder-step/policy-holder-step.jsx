...
import PolicyHolderForm from "@/pages/home-insurance/components/policy-holder-step/policy-holder-form";
...
const PolicyHolderStep = () => {
    ...
    const { isPolicyHolderValid } = useValidityContext();
    ...
    return (
        <InsuranceStepLayout
            bubbleText="Още малко информация и приключваме! Въведи данните и аз ще оформя полицата ти прецизно като архитект."
            form={<PolicyHolderForm ref={formRef} />}
            offerDetails={getOfferDetails()}
            button={{
                text: isThirdPartyBeneficiary ? "Продължи" : "Към плащане",
                onClick: () =>
                    handleContinue(
                        calculatePriceFormData,
                        propertyDetailsFormData,
