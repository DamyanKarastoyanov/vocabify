...
class BankTransferNewReminderMail extends Mailable implements ShouldQueue
{
	...
	{
		$data = [
			'subject' => 'Bizo - Нови банкови преводи (последни 24ч.)',
			'name' => 'Админ',
		...
		return $this->markdown('emails.bankTransferNewReminder')
