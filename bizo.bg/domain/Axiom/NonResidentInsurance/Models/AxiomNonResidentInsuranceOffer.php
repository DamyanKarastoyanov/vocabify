...
class AxiomNonResidentInsuranceOffer extends Model
{
    use LogsActivity, HasSelectOptionsTrait, SoftDeletes;

    protected $table = 'axiom_non_resident_insurance_offers';
    protected $fillable = [
        'axiom_id',
        'user_id',
        'order_number',
    ...
    public function axiomNonResidentInsurancePolicy()
    {
        return $this->hasOne(AxiomNonResidentInsurancePolicy::class, 'axiom_offer_id');
    }
