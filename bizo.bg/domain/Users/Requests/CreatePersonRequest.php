...
class CreatePersonRequest extends FormRequest
{
    ...
    {
        $rules = [
            'profile.personal_identification_number_type_id' => 'required|numeric',
            'profile.personal_identification_number' => 'required|max:20',
            'profile.first_name' => 'required|max:50',
